...
1. Open up [the Discord website](https://discord.com/) and [login](https://discord.com/login).
2. Hover over the "Developers" drop-down menu and click on the [Developer Portal](https://discord.com/developers/applications/) link.
