...
With the command prompt open, run the `node -v` command to make sure you've successfully installed Node.js. If you see something like <branch version="11.x" inline>`8.0.0`</branch><branch version="12.x" inline>`10.0.0`</branch>, great! If not, go back and try installing again.
