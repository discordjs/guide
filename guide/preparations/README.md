...
::: warning
If you _do_ have Node installed, but have an older version \(i.e. anything below 12.0\), you should upgrade to the latest version. discord.js v12 requires Node 12.0 or higher.
:::
...
With the command prompt open, run the `node -v` command to make sure you've successfully installed Node.js. If you see something like `v12.0`, great! If not, go back and try installing again.
