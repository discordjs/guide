...
::: warning
If you _do_ have Node installed, but have an older version \(i.e. anything below 10.0.0\), you should upgrade to the latest version. v12 requires Node 10.0.0 or higher to run.
:::
