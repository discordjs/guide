...
::: warning You need at least Node.js version 12.0 to use Commando. :::
...
\`\`\`js {6} client.registry // ... .registerGroups\(\[ \['first', 'Your First Command Group'\], \['second', 'Your Second Command Group'\], \['third', 'Your Third Command Group'\], \]\);
