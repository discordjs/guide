...
If you haven't noticed, this piece of code is already using a bit of ES6 here! The `const` keyword and arrow function syntax (`() => ...`) is a part of ES6 and is recommended to use whenever possible.
