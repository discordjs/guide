...
If you previously had `@discordjs/builders` or `@discordjs/rest` manually installed it's _highly_ recommended that you uninstall the packages to avoid package naming conflicts.
